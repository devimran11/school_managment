            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('shift.view')}}">View Class</a></li>
                        ...
                        <div class="card-body p-0">
                            <div class="row">
                                <div class="col-12 col-lg-8 offset-lg-2 col-md-8 offset-md-2">
                                    <form action="{{ route('shift.update', $editData->id) }}" method="POST">
                                        @csrf
                                        <div class="card-body">
                                            @include('admin.includes.errors')
                                            <div class="form-group">
                                                <label for="add_class">Add Shift</label>
                                                <input type="text" name="shift_name" value="{{$editData->shift_name}}" class="form-control" id="add_class">
                                            </div>
                                        </div>
